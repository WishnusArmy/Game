...
internal static class Constants
{
    ...
    //CAMERA
    internal const int SLIDE_BORDER = 200; //Defines the width of the edge that will respond to the mouse.
    internal const int SLIDE_SPEED = 6; //The speed at which the window slides.
}
