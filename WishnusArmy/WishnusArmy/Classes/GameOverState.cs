...
public class GameOverState : GameObjectList
{
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.DrawString(FNT_GAMEOVER, "GOLD GATHERED: " + GameStats.EcResources.ToString(), new Vector2((SCREEN_SIZE.X - FNT_GAMEOVER.MeasureString("GOLD GATHERED: " + GameStats.EcResources.ToString()).X) / 2, SCREEN_SIZE.Y - 500), Color.Black);
