...
public class GameOverState : GameObjectList
{
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.DrawString(FNT_GAMEOVER, "WAVES CONQUERED: " + GameStats.Wave.ToString(), new Vector2((SCREEN_SIZE.X - FNT_GAMEOVER.MeasureString("WAVES CONQUERED: " + GameStats.Wave.ToString()).X) / 2, SCREEN_SIZE.Y - 600), Color.Black);
