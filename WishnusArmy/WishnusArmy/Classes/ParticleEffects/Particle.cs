...
public class Particle : GameObject
{
    ...
    public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration, float gravity,
    ...
    {
        Position += (new Vector2(1, 0.5f) * Velocity + new Vector2(0, gravity)) * dt;
