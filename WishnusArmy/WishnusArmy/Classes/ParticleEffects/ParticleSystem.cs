...
/// </summary>
public abstract class ParticleSystem : DrawOnTop
{
    ...
    protected virtual void InitializeParticle(Particle p, Vector2 where)
    {
        ...
        p.Initialize(
            where, velocity * direction, acceleration * direction, gravity,
    ...
    public override void Update(object gameTime)
    {
        ...
        float dt = (float)(gameTime as GameTime).ElapsedGameTime.TotalSeconds;
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        foreach (Particle p in particles)
        {
            ...
            float alpha;
            if (normalizedLifetime < alphaRamp)
