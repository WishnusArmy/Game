...
public class MainMenu : GameObjectList
{
    ...
    public MainMenu()
    {
        ...
        highscoreButton.Position = new Vector2(buttonPosition.X + helpButton.Dimensions.X + 120, buttonPosition.Y);
        buttonPosition = highscoreButton.Position;
        Add(highscoreButton);

        //Add credits button
        creditsButton = new Button("CREDITS", buttonColor, hoverColor, buttonFont);
        creditsButton.Position = new Vector2(buttonPosition.X + highscoreButton.Dimensions.X + 55, buttonPosition.Y);
        Add(creditsButton);
    }
    ...
    public override void Update(object gameTime)
    {
        ...
        if (playButton.Pressed)
        {
            ...
            GameEnvironment.GameStateManager.SwitchTo("HighscoreState");
